...
class UniProtClient:
    ...
    async def fetch_protein_variants_by_accession_id(self, accession_id: str, output_dir: str):
        ...
        with open(out_path, "w", newline="") as csvfile:
            writer = csv.DictWriter(csvfile, fieldnames=["position", "original", "variant", "description"])
            writer.writeheader()
            for v in variants:
                writer.writerow(v)
